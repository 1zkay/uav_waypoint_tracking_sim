...
Gazebo 静态标记不需要手工改 world。主机航点改
`src/uav_waypoint_tracking/config/waypoints.yaml`，目标机轨迹改
`src/uav_waypoint_tracking/config/target_waypoints.yaml`，然后重启 PX4/Gazebo：
