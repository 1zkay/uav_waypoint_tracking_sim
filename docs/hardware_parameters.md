...
| 目标无人机 | `x500_1` | `model://x500_waypoint_wind` | `0 8 0 0 0 0` |
...
| 碰撞体 | 位姿 | 尺寸 |
| --- | --- | --- |
| `base_link_collision_0` | `0 0 .007 0 0 0` | `0.35355339059327373 0.35355339059327373 0.05` |
| `base_link_collision_1` | `0 -0.098 -.123 -0.35 0 0` | `0.015 0.015 0.21` |
| `base_link_collision_2` | `0 0.098 -.123 0.35 0 0` | `0.015 0.015 0.21` |
| `base_link_collision_3` | `0 -0.132 -.2195 0 0 0` | `0.25 0.015 0.015` |
| `base_link_collision_4` | `0 0.132 -.2195 0 0 0` | `0.25 0.015 0.015` |
...
| 旋翼 | Link 位姿 | 螺旋桨网格 | 电机方向 |
| --- | --- | --- | --- |
| `rotor_0` | `0.174 -0.174 0.06 0 0 0` | `1345_prop_ccw.stl` | `ccw` |
| `rotor_1` | `-0.174 0.174 0.06 0 0 0` | `1345_prop_ccw.stl` | `ccw` |
| `rotor_2` | `0.174 0.174 0.06 0 0 0` | `1345_prop_cw.stl` | `cw` |
| `rotor_3` | `-0.174 -0.174 0.06 0 0 0` | `1345_prop_cw.stl` | `cw` |
...
| 传感器 | 类型 | 更新率 | 噪声/关键参数 |
| --- | --- | ---: | --- |
| `air_pressure_sensor` | `air_pressure` | `50 Hz` | 气压高斯噪声 `stddev=3` |
| `magnetometer_sensor` | `magnetometer` | `100 Hz` | x/y/z 高斯噪声 `stddev=0.0001` |
| `imu_sensor` | `imu` | `250 Hz` | 陀螺 x/y/z `stddev=0.0008726646`；加速度 x/y `stddev=0.00637`；加速度 z `stddev=0.00686` |
| `navsat_sensor` | `navsat` | `30 Hz` | 模型中未显式设置传感器噪声 |
...
| Link | 惯性位姿 |
| --- | --- |
| `cgo3_mount_link` | `-0.02552 0 -0.08136 0 0 0` |
| `cgo3_vertical_arm_link` | `0 0 -0.1283 0 0 0` |
| `cgo3_horizontal_arm_link` | `-0.0213 0 -0.162 0 0 0` |
| `camera_link` | `-0.0412 0 -0.162 0 0 0` |
...
| PX4 参数 | 当前值 | 含义 |
| --- | ---: | --- |
| `PX4_SIM_MODEL` | `x500_gimbal` | PX4 仿真模型名 |
| `MNT_MODE_IN` | `4` | MAVLink gimbal protocol v2 输入 |
| `MNT_MODE_OUT` | `2` | MAVLink gimbal protocol v2 输出 |
| `MNT_RC_IN_MODE` | `1` | RC 输入使用角速度模式 |
| `MNT_MAN_ROLL` | `1` | 手动/RC 模式下 AUX1 控制 roll |
| `MNT_MAN_PITCH` | `2` | 手动/RC 模式下 AUX2 控制 pitch |
| `MNT_MAN_YAW` | `3` | 手动/RC 模式下 AUX3 控制 yaw |
| `MNT_RANGE_ROLL` | `180 deg` | roll 输出范围参数 |
| `MNT_RANGE_PITCH` | `180 deg` | pitch 输出范围参数 |
| `MNT_RANGE_YAW` | `720 deg` | yaw 输出范围参数 |
