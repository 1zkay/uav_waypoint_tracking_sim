...
void Missile::def_aerodynamics()
{
	...
	missile[131].init("cyb",0,"Yaw force  derivative - 1/rad ","aerodynamics","save","plot");
	missile[132].init("clnb",0,"Yaw moment derivative - 1/rad ","aerodynamics","save","plot");
	...
	missile[146].init("dnd",0,"Dimensional pitch control force derivative - m/s^2","aerodynamics","out","");
	missile[147].init("dma",0,"Dimensional pitch moment derivative - 1/s^2","aerodynamics","out","");
	missile[148].init("dmq",0,"Dimensional pitch damping derivative - 1/s","aerodynamics","out","");
	missile[149].init("dmd",0,"Dimensional pitch control derivative - 1/s^2","aerodynamics","out","");
	missile[150].init("dlp",0,"Dimensional roll damping derivative - 1/s","aerodynamics","out","");
	missile[151].init("dld",0,"Dimensional roll control derivative - 1/s^2","aerodynamics","out","");
	missile[152].init("cna",0,"Normal force derivative - 1/rad","aerodynamics","save","plot");
	missile[153].init("clma",0,"Pitch moment derivatve - 1/rad","aerodynamics","save","plot");
	missile[154].init("dlnd",0,"Dimensional yaw moment control derivative - 1/s^2","aerodynamics","out","");
	missile[159].init("stmarg_pitch",0,"Static margin in pitch (+ stable, - unstable) - diameter","aerodynamics","save","plot");
	missile[160].init("realq1",0,"First real root of airframe pitch dynamics - rad/s","aerodynamics","diag","scrn");
	missile[161].init("realq2",0,"Second real root of airframe pitch dynamics - rad/s","aerodynamics","diag","scrn");
	missile[162].init("wnq",0,"Natural frequency of airframe in pitch plane - rad/s","aerodynamics","diag","");
	missile[163].init("zetq",0,"Damping of airframe in pitch plane - NA","aerodynamics","diag","");
	...
	missile[172].init("wnr",0,"Natural frequency of airframe in yaw plane - rad/s","aerodynamics","diag","");
	...
	missile[175].init("realr1",0,"First real root of airframe yaw dynamics - rad/s","aerodynamics","diag","");
	missile[176].init("realr2",0,"Second real root of airframe yaw dynamics - rad/s","aerodynamics","diag","");
	missile[177].init("prreal",0,"Real part or mean value (real roots) of yaw dyn - rad","aerodynamics","diag","");	
...
void Missile::aerodynamics_der()
{
	...
	//pitch control force derivative 'dnd' 
	dnd=(pdynmc*refa/mass)*cndq;

	//yaw moment control dim derivative 'dlnd'
