...
echo "Gimbal tracking: $(launch_arg_value enable_gimbal_tracking "${ENABLE_GIMBAL_TRACKING}") input=$(launch_arg_value gimbal_input_topic "${GIMBAL_INPUT_TOPIC}") attitude=$(launch_arg_value gimbal_attitude_topic "${GIMBAL_ATTITUDE_TOPIC}")"
